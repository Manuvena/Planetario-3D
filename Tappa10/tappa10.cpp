...
public:
    ...
    sf::Window* win;
    GLint m_loc, vp_loc, light_pos_loc, is_sun_loc, tex_loc, color_loc, is_orbit_loc; //per conservare posizioni delle uniform nello shader
    ...
    void draw(float simulated_time) {
        ...
        glUniformMatrix4fv(m_loc, 1, GL_FALSE, &centro_terra_static[0][0]); //passo centro_terra_static come matrice model, e disegno orbita luna che sarà cetnrata nella terra
